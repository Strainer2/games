...
class GlossGame(object):
    ...
    def gloss_internal_update(self):
        for particlesystem in reversed(Gloss.auto_particle_systems):
            ...
            if particlesystem.frozen is True:
                continue
        ...
        while Gloss.game_is_running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == MOUSEBUTTONUP:
                    ...
                    if Gloss.sprite_click_tracking is True:
...
class Gloss(object):
    ...
    def fill(texture = None, color = Color.WHITE, top = Color.CORNFLOWER_BLUE, bottom = Color.CORNFLOWER_BLUE, vertical = True):
        ...
        if texture is not None:
            ...
            glTexCoord2f(0, texture.height_ratio); glVertex3f(0, height, 0)
            glTexCoord2f(texture.width_ratio, texture.height_ratio); glVertex3f(width, height, 0)
            glTexCoord2f(0, 1); glVertex3f(0, 0, 0)
            glTexCoord2f(texture.width_ratio, 1); glVertex3f(width, 0, 0)
            glEnd()
        else:
            ...
            if vertical is True:
                glBegin(GL_TRIANGLE_STRIP)
                glColor4f(bottom.r, bottom.g, bottom.b, bottom.a); glVertex3f(0, height, 0)
                glColor4f(bottom.r, bottom.g, bottom.b, bottom.a); glVertex3f(width, height, 0)
                glColor4f(top.r, top.g, top.b, top.a); glVertex3f(0, 0, 0)
                glColor4f(top.r, top.g, top.b, top.a); glVertex3f(width, 0, 0)
                glEnd()
            else:
                glBegin(GL_TRIANGLE_STRIP)
                glColor4f(top.r, top.g, top.b, top.a); glVertex3f(0, height, 0)
                glColor4f(bottom.r, bottom.g, bottom.b, bottom.a); glVertex3f(width, height, 0)
                glColor4f(top.r, top.g, top.b, top.a); glVertex3f(0, 0, 0)
                glColor4f(bottom.r, bottom.g, bottom.b, bottom.a); glVertex3f(width, 0, 0)
                glEnd()
    ...
    def save_screenshot(filename):
        if Gloss.redraw_needed is True:
...
class Texture(object):
    def __init__(self, path):
        ...
        try:
            ...
            print("Unable to load texture " + path + ".")
            sys.exit(1)
    ...
    def draw(self, position = (0, 0), rotation = 0.0, origin = (0, 0), scale = 1, color = Color.WHITE):
        ...
        glBegin(GL_TRIANGLE_STRIP)
        glTexCoord2f(0, self.height_ratio); glVertex3f(-originx, texheight - originy, 0)
        glTexCoord2f(self.width_ratio, self.height_ratio); glVertex3f(texwidth - originx, texheight - originy, 0)
        glTexCoord2f(0, 1); glVertex3f(-originx, -originy, 0)
        glTexCoord2f(self.width_ratio, 1); glVertex3f(texwidth - originx, -originy, 0)
        glEnd()
...
class Sprite(object):
    ...
    def __init__(self, texture, position = None):
        ...
        Gloss.sprites.append(self)

    def __del__(self):
        Gloss.sprites.remove(self)
    ...
    def draw(self, position = None, rotation = 0.0, origin = (0, 0), scale = 1, color = Color.WHITE):
        ...
        glBegin(GL_TRIANGLE_STRIP)
        glTexCoord2f(0, self.texture.height_ratio); glVertex3f(-originx, texheight - originy, 0)
        glTexCoord2f(self.texture.width_ratio, self.texture.height_ratio); glVertex3f(texwidth - originx, texheight - originy, 0)
        glTexCoord2f(0, 1); glVertex3f(-originx, -originy, 0)
        glTexCoord2f(self.texture.width_ratio, 1); glVertex3f(texwidth - originx, -originy, 0)
        glEnd()
...
class ParticleSystem(object):
    def __init__(self, texture, position = None, lifespan = -1, creationspeed = None, initialparticles = 50, particlelifespan = 1000, minspeed = 50, maxspeed = 250, minrotation = 0, maxrotation = 0, minscale = 1.0, maxscale = 1.0, growth = 0.0, wind = None, drag = 0, startcolor = Color.WHITE, endcolor = Color.TRANSPARENT_WHITE, onfinish = None, name = ""):
    ...
    def draw(self):
        ...
        for particle in reversed(self.particles):
            particle.texture.draw(position = particle.position, rotation = particle.rotation, origin = None, scale = particle.scale + (particle.anim_pos * self.particle_growth), color = particle.color)
    ...
    def update(self):
        ...
        for particle in reversed(self.particles):
            ...
            particle.position = Point.add(particle.position, Point.multiply(self.particle_wind, Gloss.elapsed_seconds))
            ...
            particle.velocity = Point.subtract(particle.velocity, Point.multiply(particle.velocity, Gloss.elapsed_seconds * self.particle_drag))
...
class RenderTarget:
    ...
    def draw(self, position, width = None, height = None, rotation = 0.0, origin = (0, 0), scale = 1, color = Color.WHITE):
        ...
        glBegin(GL_TRIANGLE_STRIP)
        glTexCoord2f(0, 0); glVertex3f(-originx, texheight - originy, 0)
        glTexCoord2f(1, 0); glVertex3f(texwidth - originx, texheight - originy, 0)
        glTexCoord2f(0, 1); glVertex3f(-originx, -originy, 0)
        glTexCoord2f(1, 1); glVertex3f(texwidth - originx, -originy, 0)
        glEnd()
    ...
    def draw(self, text = "Hello, Gloss!", position = (0, 0), rotation = 0.0, scale = 1.0, color = Color.WHITE, letterspacing = 0, linespacing = 0):
        ...
        for line in lines:
            for letter in line:
                ...
                glBegin(GL_TRIANGLE_STRIP)
                glTexCoord2f(0, lettertexture.height_ratio); glVertex3f(0, texheight, 0)
                glTexCoord2f(lettertexture.width_ratio, lettertexture.height_ratio); glVertex3f(texwidth, texheight, 0)
                glTexCoord2f(0, 1); glVertex3f(0, 0, 0)
                glTexCoord2f(lettertexture.width_ratio, 1); glVertex3f(texwidth, 0, 0)
                glEnd()
